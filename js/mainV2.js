...
// let predictedAges = new Array(30).fill(0);
// let currentAgeIndex = 0;
// let registeredDescriptors = {};
// let lastUpdateTime = 0;
// const updateInterval = 1000; // Cập nhật mỗi 1000ms (1 giây)
...
// // Hàm tải dữ liệu
// function loadData() {
//   const savedData = localStorage.getItem("faceData");
//   if (savedData) {
...
//   if (!detections) {
//     showPopup(`❌ Không tìm thấy khuôn mặt, hãy thử lại!`);
//     return;
//   }
...
//     const { age, gender, expressions } = fullDetections[0];
//     const interpolatedAge = interpolateAgePredictions(age);
//     const emotion = Object.keys(expressions).reduce((a, b) =>
//       expressions[a] > expressions[b] ? a : b
//     );

//     captureAndExport(label, interpolatedAge, gender, emotion); // Truyền label
//   }
//   showPopup(`✅ Đã lưu khuôn mặt của ${label}`);
// }
...
//   if (!detections) {
//     showPopup(`❌ Không tìm thấy khuôn mặt!`);
//     return;
//   }

//   console.log("Registered Descriptors:", registeredDescriptors);
...
//     }
//   } catch (error) {
//     console.error("Lỗi khi tạo FaceMatcher:", error);
//     alert("❌ Lỗi xác minh khuôn mặt!");
//   }
// }
...
//   predictedAges[currentAgeIndex] = age;
//   currentAgeIndex = (currentAgeIndex + 1) % predictedAges.length;
...
//     a.href = url;
//     a.download = `${label}-face-${Date.now()}.png`;
//     a.click();
...
//   console.log("Metadata đã tải, webcam đã hoạt động!");
...
function captureAndExport(label, age, gender, emotion) {
  ...
  canvas.toBlob((blob) => {
    ...
    a.download = `${label}-face-${Date.now()}.png`; // Đặt tên file tải xuống
